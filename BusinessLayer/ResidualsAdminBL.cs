...
namespace BusinessLayer
{
    public class ResidualsAdminBL
    {
        ...
        public DataSet GetDroppedResidualsOffice(string Report, string OfficeMasterNum)
        {
            ResidualsDL DroppedResd = new ResidualsDL();
            DataSet ds = DroppedResd.GetDroppedResdOffice(Report, Month, OfficeMasterNum);
            return ds;
        }//end function GetDroppedResiduals
        ...
        public DataSet GetActivatedResidualsOffice(string Report, string OfficeMasterNum)
        {
            ResidualsDL ActivatedResd = new ResidualsDL();
            DataSet ds = ActivatedResd.GetActivatedResdOffice(Report, Month, OfficeMasterNum);
            return ds;
        }//end function GetActivatedResiduals
        ...
        public PartnerDS.PivotalDataTable GetPivotalResidualsByDBA(string DBA)
        {
            PivotalTableAdapter PivotalAdapter = new PivotalTableAdapter();
            return PivotalAdapter.GetDataByDBA(DBA);
        }//end function GetIMS2ResidualsByDBA
        ...
        public PartnerDS.RevelDataTable GetRevelResidualsByDBA(string DBA)
        {
            RevelTableAdapter RevelAdapter = new RevelTableAdapter();
            return RevelAdapter.GetDataByDBA(DBA);
