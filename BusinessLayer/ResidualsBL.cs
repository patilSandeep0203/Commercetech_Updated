...
namespace BusinessLayer
{
    public class ResidualsBL
    {
        ...
        private string PivotalNum = "";
        private string SageNum = "";
        private string IPayNum = "";
        private string IPay2Num = "";
        private string IPay3Num = "";
        private string ChaseNum = "";
        private string MerrickNum = "";
        private string AuthnetNum = "";
        private string IpayGateNum = "";
        private string InnGateNum = "";
        private string PlugNPayNum = "";
        private string DiscNum = "";
        private string CSNum = "";
        private string GCNum = "";
        private string CTCartNum = "";
        ...
        public ResidualsBL(string Month, string MasterNum)
        {
            ...
            if (MasterNum == "ALL")
            {
                ...
                this.MerrickNum = "ALL";
                this.AuthnetNum = "ALL";
                this.IpayGateNum = "ALL";
                //this.InnGateNum = "ALL";
                this.PlugNPayNum = "ALL";
                //this.DiscNum = "ALL";
                this.CSNum = "ALL";
                this.GCNum = "ALL";
                this.CTCartNum = "ALL";
            ...
            else
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    this.PivotalNum = dr["PivotalNum"].ToString().Trim();
                    this.SageNum = dr["SageNum"].ToString().Trim();
                    this.ChaseNum = dr["ChaseNum"].ToString().Trim();
                    //this.MerrickNum = dr["MerrickNum"].ToString().Trim();
                }
            }
        ...
        public string ReturnPivotalNum()
        {
            return this.PivotalNum;
        }
        ...
        public string ReturnMerrickNum()
        {
            return this.MerrickNum;
        }

        public string ReturnAuthnetNum()
        {
            return this.AuthnetNum;
        }

        public string ReturnIpayGateNum()
        {
            return this.IpayGateNum;
        }

        /*public string ReturnInnGateNum()
        {
            return this.InnGateNum;
        }*/

        public string ReturnPlugNPayNum()
        {
            return this.PlugNPayNum;
        }


        /*public string ReturnDiscNum()
        {
            return this.DiscNum ;
        }*/

        public string ReturnCSNum()
        {
            return this.CSNum;
        }

        public string ReturnGCNum()
        {
            return this.GCNum;
        }

        public string ReturnCTCartNum()
        {
            return this.CTCartNum;
        }

        public string ReturnMCANum()
        {
            return this.MCANum;
        }

        public string ReturnPayrollNum()
        {
            return this.PayrollNum;
        }
        ...
        public PartnerDS.PivotalDataTable GetPivotalResiduals()
        {
            PivotalTableAdapter Adapter = new PivotalTableAdapter();
            return Adapter.GetData(MasterNum, Month);
        }//end function GetIPSResiduals
        ...
        //This function gets Pivotal totals
        public DataSet GetPivotalTotals()
        {
            ResidualsDL PivotalResd = new ResidualsDL();
            DataSet ds = PivotalResd.ReturnPivotalTotals(MasterNum, Month);
            return ds;
        }//end function GetIPSTotals
        ...
        //This function returns Authnet residuals
        public PartnerDS.RevelDataTable GetRevelResiduals()
        {
            RevelTableAdapter RevelAdapter = new RevelTableAdapter();
            return RevelAdapter.GetData(MasterNum, Month);
        }//end function GetAuthnetResiduals

        //This function returns Authnet Totals
        public DataSet GetRevelTotals()
        {
            ResidualsDL RevelResd = new ResidualsDL();
            DataSet ds = RevelResd.ReturnRevelTotals(MasterNum, Month);
            return ds;
