...
namespace DLPartner
{
    public class SalesOppDL
    {
        ...
        public bool AddSalesOppInfo(string Code, string SellPrice, string COG, string Quantity, string ACTUserID,
            int AppId, string RepNum, string PaymentMethod, string Reprogram, string TerminalID)
        {
            ...
            try
            {
                ...
                SqlParameter pQuantity = cmd.Parameters.Add("@Quantity", SqlDbType.SmallInt);
                ...
                SqlParameter pTerminalID = cmd.Parameters.Add("@TerminalID", SqlDbType.Char);
