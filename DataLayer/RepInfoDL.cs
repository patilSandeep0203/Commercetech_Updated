...
namespace DLPartner
{
    public class RepInfoDL
    {
        ...
        public DataSet GetOfficeByRep(string officeMaterNum)
        {
            SqlConnection Conn = new SqlConnection(ConnString);
            try
            {
                SqlCommand cmdRepList = new SqlCommand("sp_GetOfficeByRep", Conn);
                cmdRepList.CommandType = CommandType.StoredProcedure;
                SqlDataAdapter adapter = new SqlDataAdapter();
                adapter.SelectCommand = cmdRepList;
                cmdRepList.Parameters.Add(new SqlParameter("@OfficeMasterNum ", officeMaterNum));
                DataSet ds = new DataSet();
                adapter.Fill(ds);
                Conn.Close();
                Conn.Dispose();
        ...
        public DataSet GetSalesRepListByOffice(string officeMaterNum)
        {
            SqlConnection Conn = new SqlConnection(ConnString);
            try
            {
                SqlCommand cmdRepList = new SqlCommand("sp_GetRepListByOffice", Conn);
                cmdRepList.CommandType = CommandType.StoredProcedure;
                SqlDataAdapter adapter = new SqlDataAdapter();
                adapter.SelectCommand = cmdRepList;
                cmdRepList.Parameters.Add(new SqlParameter("@OfficeMasterNum ", officeMaterNum));
