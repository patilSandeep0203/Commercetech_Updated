...
namespace DLPartner
{
    public class BoundsDL
    {
        ...
        public DataSet GetProcessorBoundComplianceFeeLow(int ProcessorID)
        {
            SqlConnection Conn = new SqlConnection(ConnString);
            try
            {
        ...
        public bool UpdateBounds(string LastModified, string CustServFeeLow, string InternetStmtLow, string TransFeeLow, string DRQPLow,
           string DRQNPLow, string DRMQLow, string DRNQLow, string AmexQualLow, string AmexMidQualLow, string AmexNonQualLow, string DRQDLow,
            string QualNPDebit, string MidQualDebit, string NonQualDebit, string ChargebackFeeLow,
            string RetrievalFeeLow, string VoiceAuthLow, string BatchHeaderLow, string AVSLow, string MonMinLow,
            string NBCTransFeeLow, string AnnualFeeLow, string WirelessAccessFeeLow, string WirelessTransFeeLow,
            string AppFeeLow, string AppSetupFeeLow, string ProcessorID, string DebitMonFee, string DebitTransFee, string PinDebitDiscount, 
            string EBTMonFee, string EBTTransFee, string ComplianceFee)
        {
            SqlConnection Conn = new SqlConnection(ConnString);
            try
            {
                SqlCommand cmdBounds = new SqlCommand("sp_UpdateBoundsComplianceFee", Conn);
                cmdBounds.CommandType = CommandType.StoredProcedure;
                SqlParameter pLastModified = cmdBounds.Parameters.Add("@LastModified", SqlDbType.VarChar);
                SqlParameter pCustServFee = cmdBounds.Parameters.Add("@CustServFee", SqlDbType.VarChar);
                SqlParameter pInternetStmtLow = cmdBounds.Parameters.Add("@InternetStmt", SqlDbType.VarChar);
                ...
                SqlParameter pAmexQualLow = cmdBounds.Parameters.Add("@AmexQualLow", SqlDbType.VarChar);
                SqlParameter pAmexMidQualLow = cmdBounds.Parameters.Add("@AmexMidQualLow", SqlDbType.VarChar);
                SqlParameter pAmexNonQualLow = cmdBounds.Parameters.Add("@AmexNonQualLow", SqlDbType.VarChar);

                SqlParameter pDRQDLow = cmdBounds.Parameters.Add("@DiscRateQualDebit", SqlDbType.VarChar);

                SqlParameter pQualNPDebit = cmdBounds.Parameters.Add("@QualNPDebit", SqlDbType.VarChar);
                SqlParameter pMidQualDebit = cmdBounds.Parameters.Add("@MidQualDebit", SqlDbType.VarChar);
                SqlParameter pNonQualDebit = cmdBounds.Parameters.Add("@NonQualDebit", SqlDbType.VarChar);
                ...
                SqlParameter pDebitMonFee = cmdBounds.Parameters.Add("@DebitMonFee", SqlDbType.VarChar);
                SqlParameter pDebitTransFee = cmdBounds.Parameters.Add("@DebitTransFee", SqlDbType.VarChar);
                SqlParameter pPinDebitDiscount = cmdBounds.Parameters.Add("@PinDebitDiscount", SqlDbType.VarChar);
                SqlParameter pEBTMonFee = cmdBounds.Parameters.Add("@EBTMonFee", SqlDbType.VarChar);
                SqlParameter pEBTTransFee = cmdBounds.Parameters.Add("@EBTTransFee", SqlDbType.VarChar);
                ...
                pAmexQualLow.Value = AmexQualLow;
                pAmexMidQualLow.Value = AmexMidQualLow;
                pAmexNonQualLow.Value = AmexNonQualLow;
            ...
            string EBTMonFee, string EBTTransFee, string ComplianceFee)
        {
            ...
            try
            {
                ...
                pDebitMonFee.Value = DebitMonFee;
                pDebitTransFee.Value = DebitTransFee;
                pPinDebitDiscount.Value = pPinDebitDiscount;
                pEBTMonFee.Value = EBTMonFee;
                pEBTTransFee.Value = EBTTransFee;
                pComplianceFee.Value = ComplianceFee;
        ...
        public bool UpdateDefaults(string LastModified, string CustServFeeLow, string InternetStmtLow, string TransFeeLow, string DRQPLow,
            string DRQNPLow, string DRMQLow, string DRNQLow, string AmexQual, string AmexMidQual, string AmexNonQual, string DRQDLow, string QualNPDebit, string MidQualDebit, string NonQualDebit, string ChargebackFeeLow,
            string RetrievalFeeLow, string VoiceAuthLow, string BatchHeaderLow, string AVSLow, string MonMinLow,
            string NBCTransFeeLow, string AnnualFeeLow, string WirelessAccessFeeLow, string WirelessTransFeeLow,
            string AppFeeLow, string AppSetupFeeLow, string ProcessorID, string DebitMonFee, string DebitTransFee, 
            string EBTMonFee, string EBTTransFee, string ComplianceFee)
        {
            ...
            try
            {
                SqlCommand cmdBounds = new SqlCommand("sp_UpdateDefaultsProcessor1", Conn);
                cmdBounds.CommandType = CommandType.StoredProcedure;
                SqlParameter pLastModified = cmdBounds.Parameters.Add("@LastModified", SqlDbType.VarChar);
                SqlParameter pCustServFee = cmdBounds.Parameters.Add("@CustServFee", SqlDbType.VarChar);
                SqlParameter pInternetStmtLow = cmdBounds.Parameters.Add("@InternetStmt", SqlDbType.VarChar);
                ...
                SqlParameter pAmexQual = cmdBounds.Parameters.Add("@AmexDiscRateQual", SqlDbType.VarChar);
                SqlParameter pAmexMidQual = cmdBounds.Parameters.Add("@AmexDiscRateMidQual", SqlDbType.VarChar);
                SqlParameter pAmexNonQual = cmdBounds.Parameters.Add("@AmexDiscRateNonQual", SqlDbType.VarChar);
                ...
                pAmexQual.Value = AmexQual;
                pAmexMidQual.Value = AmexMidQual;
                pAmexNonQual.Value = AmexNonQual;
