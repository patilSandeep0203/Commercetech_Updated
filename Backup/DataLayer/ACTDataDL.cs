...
namespace DLPartner
{
    public class ACTDataDL
    {
       ...
       //CALLED BY ExportActBL.AddInfoToACT
        public bool AddDataContact(string CREATEDATE, string P1fullname, string LegalStatus, string P1FirstName, 
            ...
            string DiscNQ, string DiscQD, string DiscQP, string TransFee, string RetrievalFee, 
            ...
            string PayrollType, bool Payroll, string MCAType, int AppId)
        {
            SqlConnection ConnACT = new SqlConnection(ConnStringACT);
            try
            {
        ...
        public bool InsertSalesOpp(string ID, string ContactID, string OppUserID, string Product,
            ...
            string LastModified, string CreateDate, string PaymentMethod, string Reprogram)
        {
            SqlConnection ConnACT = new SqlConnection(ConnStringACT);
            try
            {
        ...
        */
        ...
        public DataSet GetCommissionsFromACT()
        {
            SqlConnection Conn = new SqlConnection(ConnStringACT);
            try
            {
