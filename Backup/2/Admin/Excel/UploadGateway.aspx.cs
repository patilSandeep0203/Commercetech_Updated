...
public partial class UploadGateway : System.Web.UI.Page
{
    ...
    public void GenerateExcelFile()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            for (int i = 0; i < dt[0].Table.Columns.Count - 1; i++)
                oSheet.Cells[1, i + 1] = dt[0].Table.Columns[i].ToString().Trim();
            ...
            else if (lstPlatform.SelectedItem.Text == "Vital")
            {
                ...
                oSheet.Cells[1, 54] = "'" + txtVisaMasterNumber.Text;
        ...
        lblDownload.Text = "<a class=One href=http://" + strMachineName + "/Admin/Excel/" + strFile + ">Download File</a>";
    ...
    public void DisablePlatformFields()
    {
        ...
        else if (lstPlatform.SelectedItem.Text == "Vital")
        {
            ...
            txtVisaMasterNumber.MaxLength = 12;
            ...
            if ((txtVisaMasterNumber.Text.Length < 12) || (txtVisaMasterNumber.Text.Length > 12))
            {
                lblError.Visible = true;
                lblError.Text += "Visa Master Number length must be 12 characters long. Please correct in ACT!<br/>";
            }
