<%@ Page Language="C#" MasterPageFile="~/Reports/Admin.master" AutoEventWireup="true" CodeFile="Sage.aspx.cs" Inherits="Residuals_Sage" Title="E-Commerce Exchange - Partner Portal" Theme="Admin" %>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 260px;" class="SilverBorder">
        <tr>
            <td align="center" colspan="3" style="background-image: url(/PartnerPortal/Images/topMain.gif);
                height: 25px">
                <b><span class="MenuHeader">Sage Residual Reports</span></b></td>
        </tr>
        <tr>
            <td>
