<%@ Page Language="C#" MasterPageFile="~/ACT/Admin.master" AutoEventWireup="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width: 400px;" class="SilverBorder">
        <tr>
            <td align="center" colspan="3" style="height: 25px; background-image: url(../../Images/topMain.gif)">
                <b><span style="font-size: small; font-family: Arial; color: White">Create File</span></b>
            </td>
        </tr>
     ...
     <asp:Panel ID="pnlNote" runat="server" BackColor="Ivory" BorderColor="silver" BorderWidth="1px" Width="50%">
        <div class="LabelsRed">
            <span style="font-size: small; font-family: Arial;">
            File will be saved to Customer Folder.<br>
            For Authorize.net uploads only. Go <a href="https://account.authorize.net/interfaces/reseller/frontend/login.aspx" target=_blank>here</a> to upload the file. <br>
            Note: You may need to remove quotation marks to correctly upload the file.
             </span>
        </div>
    </asp:Panel>
    ...
    <asp:GridView ID="grdPDF" runat="server" AutoGenerateColumns="False" CellPadding="4"
        ...
        <Columns>
            ...
            <asp:ButtonField CommandName="CreateFile" Text="Create File">
